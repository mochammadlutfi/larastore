                  ...
                  if (_push4) {
                    ...
                    _push4(ssrRenderComponent(_component_el_row, { gutter: 20 }, {
                      default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                        if (_push5) {
                          _push5(`<!--[-->`);
                          ssrRenderList($props.data.data, (d, i) => {
                            _push5(ssrRenderComponent(_component_el_col, {
                              ...
                              default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                if (_push6) {
                                  _push6(`<div class="product"${_scopeId5}><div class="product-content"${_scopeId5}><div class="product-img"${_scopeId5}><img${ssrRenderAttr("src", d.main_image)} class="img-fluid"${_scopeId5}></div><div class="product-info"${_scopeId5}><div class="product-title"${_scopeId5}>${ssrInterpolate(d.name)} </div><div class="product-price"${_scopeId5}>${ssrInterpolate(_ctx.currency(d.sell_price))}</div>`);
                                  _push6(ssrRenderComponent(_component_el_row, { gutter: 10 }, {
                                    default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                      if (_push7) {
                                        _push7(ssrRenderComponent(_component_el_col, { lg: 12 }, {
                                          default: withCtx((_7, _push8, _parent8, _scopeId7) => {
                                            if (_push8) {
                                              _push8(`<a${ssrRenderAttr("href", _ctx.route("product.show", { "slug": d.slug, "grosir": 0 }))} class="ep-button ep-button--primary ep-button--small w-100"${_scopeId7}>Eceran</a>`);
                                            } else {
                                              return [
                                                createVNode("a", {
                                                  href: _ctx.route("product.show", { "slug": d.slug, "grosir": 0 }),
                                                  class: "ep-button ep-button--primary ep-button--small w-100"
                                                }, "Eceran", 8, ["href"])
                                              ];
                                            }
                                          }),
                                        ...
                                        _push7(ssrRenderComponent(_component_el_col, { lg: 12 }, {
                                          default: withCtx((_7, _push8, _parent8, _scopeId7) => {
                                            if (_push8) {
                                              _push8(`<a${ssrRenderAttr("href", _ctx.route("product.show", { "slug": d.slug, "grosir": 1 }))} class="ep-button ep-button--primary ep-button--small w-100 is-plain"${_scopeId7}>Grosir</a>`);
                                            } else {
                                              return [
                                                createVNode("a", {
                                                  href: _ctx.route("product.show", { "slug": d.slug, "grosir": 1 }),
                                                  class: "ep-button ep-button--primary ep-button--small w-100 is-plain"
                                                }, "Grosir", 8, ["href"])
                                              ];
                                            }
                                          }),
                                    ...
                                    createVNode("div", { class: "product" }, [
                                      createVNode("div", { class: "product-content" }, [
                                        ...
                                        createVNode("div", { class: "product-info" }, [
                                          createVNode("div", { class: "product-title" }, toDisplayString(d.name) + " ", 1),
                          ...
                          return [
                            (openBlock(true), createBlock(Fragment, null, renderList($props.data.data, (d, i) => {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Frontend/Product/Index.vue");

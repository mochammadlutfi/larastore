import { C as ClickOutside, S as SelectOrder } from "./SelectOrder.js";
import { getCurrentInstance, ref, unref, computed, watch, toRefs, nextTick, isRef, defineComponent, resolveComponent, resolveDirective, openBlock, createBlock, withCtx, createElementBlock, createElementVNode, normalizeClass, createVNode, Fragment, renderList, createTextVNode, toDisplayString, withDirectives, onBeforeMount, onMounted, onUpdated, onUnmounted, inject, h, watchEffect, provide, normalizeStyle, renderSlot, createCommentVNode, vShow, Comment, onBeforeUnmount, withModifiers, useSSRContext } from "vue";
import { ssrRenderComponent, ssrInterpolate } from "vue/server-renderer";
import { L as throwError, f as isBoolean, Q as useDelayedToggle, R as createPopper, n as useNamespace, S as ElScrollbar, U as ElTooltip, a as ElIcon, u as useLocale, c as _export_sfc, O as addClass, K as isElement, M as hasClass, P as removeClass, g as useZIndex, N as getStyle, v as useFormSize, t as useSizeProp, s as isNumber, V as getProp, A as debugWarn, J as isUndefined, w as withInstall, D as withNoopInstall, _ as _export_sfc$1, E as ElButton } from "./ssr.js";
import { E as ElMessage } from "./index7.js";
import { E as ElForm, a as ElFormItem } from "./index9.js";
import { merge, flatMap, get, debounce } from "lodash-unified";
...
import { ArrowDown, ArrowUp, ArrowRight, Loading } from "@element-plus/icons-vue";
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  const _component_select_order = resolveComponent("select-order");
      ...
      if (_push2) {
        _push2(ssrRenderComponent(_component_el_form, {
          ...
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<div class="d-flex justify-content-between align-items-center mb-4"${_scopeId2}><h3 class="fs-4 fw-bold mb-0"${_scopeId2}>Pengajuan Retur</h3><div class="space-x-1"${_scopeId2}><button class="ep-button ep-button--primary"${_scopeId2}><i class="fa fa-check me-1"${_scopeId2}></i> Kirim </button></div></div><div class="block rounded block-bordered"${_scopeId2}><div class="block-content p-3"${_scopeId2}>`);
              _push3(ssrRenderComponent(_component_el_form_item, {
                label: "Pilih Pesanan",
                error: $props.errors.order_id
              }, {
                default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                  if (_push4) {
                    _push4(ssrRenderComponent(_component_select_order, {
                      modelValue: $data.form.order_id,
                      "onUpdate:modelValue": ($event) => $data.form.order_id = $event,
                      onChange: $options.fetchData
                    }, null, _parent4, _scopeId3));
                  } else {
                    return [
                      createVNode(_component_select_order, {
                        modelValue: $data.form.order_id,
                        "onUpdate:modelValue": ($event) => $data.form.order_id = $event,
                        onChange: $options.fetchData
              ...
              _push3(ssrRenderComponent(_component_el_table, {
                ...
                default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                  if (_push4) {
                    _push4(ssrRenderComponent(_component_el_table_column, { label: "Produk" }, {
                      default: withCtx((scope, _push5, _parent5, _scopeId4) => {
                        if (_push5) {
                          _push5(`<div${_scopeId4}>${ssrInterpolate(scope.row.product)} `);
                          if (scope.row.product) {
                            _push5(`<!--[--> - ${ssrInterpolate(scope.row.variant)}<!--]-->`);
                          } else {
                            _push5(`<!---->`);
                          }
                          _push5(`</div><div${_scopeId4}>${ssrInterpolate(scope.row.sku)}</div>`);
                        } else {
                          return [
                            createVNode("div", null, [
                              createTextVNode(toDisplayString(scope.row.product) + " ", 1),
                              scope.row.product ? (openBlock(), createBlock(Fragment, { key: 0 }, [
                                createTextVNode(" - " + toDisplayString(scope.row.variant), 1)
                              ], 64)) : createCommentVNode("", true)
                            ]),
                            createVNode("div", null, toDisplayString(scope.row.sku), 1)
                          ];
                        }
                      }),
                      _: 1
                    ...
                    _push4(ssrRenderComponent(_component_el_table_column, {
                      ...
                      default: withCtx((scope, _push5, _parent5, _scopeId4) => {
                        if (_push5) {
                          _push5(`${ssrInterpolate(scope.row.qty_order)}`);
                        } else {
                          return [
                            createTextVNode(toDisplayString(scope.row.qty_order), 1)
                          ];
                        }
                      }),
                      _: 1
                      ...
                      default: withCtx((scope, _push5, _parent5, _scopeId4) => {
                        if (_push5) {
                          _push5(ssrRenderComponent(_component_el_input_number, {
                            ...
                            "onUpdate:modelValue": ($event) => scope.row.qty = $event,
                            min: 1,
                            max: scope.row.qty_order
                    ...
                    _push4(ssrRenderComponent(_component_el_table_column, { label: "Alasan" }, {
                      default: withCtx((scope, _push5, _parent5, _scopeId4) => {
                        if (_push5) {
                          _push5(ssrRenderComponent(_component_el_input, {
                            modelValue: scope.row.reason,
                            "onUpdate:modelValue": ($event) => scope.row.reason = $event
                          }, null, _parent5, _scopeId4));
                        } else {
                          return [
                      ...
                      default: withCtx((scope, _push5, _parent5, _scopeId4) => {
                        if (_push5) {
                          _push5(ssrRenderComponent(_component_el_button, {
                            type: "danger",
                            size: "small",
                            onClick: ($event) => $options.removeLine(scope.$index, scope.row.id)
                          }, {
                            default: withCtx((_4, _push6, _parent6, _scopeId5) => {
                              if (_push6) {
                                _push6(`<i class="fa fa-times"${_scopeId5}></i>`);
                              } else {
                                return [
                    ...
                    return [
                      createVNode(_component_el_table_column, { label: "Produk" }, {
                      ...
                      createVNode(_component_el_table_column, { label: "Alasan" }, {
                        default: withCtx((scope) => [
                          createVNode(_component_el_input, {
                            modelValue: scope.row.reason,
                            "onUpdate:modelValue": ($event) => scope.row.reason = $event
              ...
              return [
                createVNode("div", { class: "d-flex justify-content-between align-items-center mb-4" }, [
                  createVNode("h3", { class: "fs-4 fw-bold mb-0" }, "Pengajuan Retur"),
                  createVNode("div", { class: "space-x-1" }, [
                    createVNode("button", { class: "ep-button ep-button--primary" }, [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Frontend/UserReturn/Form.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const Form = /* @__PURE__ */ _export_sfc$1(_sfc_main, [["ssrRender", _sfc_ssrRender]]);
export {
  Form as default
};

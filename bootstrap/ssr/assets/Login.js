            ...
            if (_push3) {
              _push3(ssrRenderComponent(_component_el_col, {
                ...
                default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                  if (_push4) {
                    _push4(`<div class="text-center"${_scopeId3}><h2 class="font-weight-bold mb-0"${_scopeId3}>Masuk</h2><p${_scopeId3}>Belum punya akun? <a${ssrRenderAttr("href", _ctx.route("register"))}${_scopeId3}>Daftar</a> di sini</p></div>`);
                    ...
                    return [
                      createVNode("div", { class: "text-center" }, [
                        createVNode("h2", { class: "font-weight-bold mb-0" }, "Masuk"),
                        createVNode("p", null, [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Frontend/Auth/Login.vue");
